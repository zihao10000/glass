...
#define MV_CODEREADER_E_ENCRYPT                             0x8002000E  ///< 加密错误
#define MV_CODEREADER_E_FILE_PATH                           0x8002000F  ///< 文件路径错误
#define MV_CODEREADER_E_BUF_IN_USE                          0x80020010  ///< 缓存地址已使用
#define MV_CODEREADER_E_BUF_INVALID                         0x80020011  ///< 无效的缓存地址
#define MV_CODEREADER_E_NOALIGN_BUF                         0x80020012  ///< 缓存对齐异常
#define MV_CODEREADER_E_NOENOUGH_BUF_NUM                    0x80020013  ///< 缓存个数不足
#define MV_CODEREADER_E_PORT_IN_USE                         0x80020014  ///< 串口被占用
#define MV_CODEREADER_E_IMAGE_DECODEC                       0x80020015  ///< 解码错误(SDK校验图像异常)
#define MV_CODEREADER_E_UINT32_LIMIT                        0x80020016  ///< 图像大小超过unsigned int返回，接口不支持   
#define MV_CODEREADER_E_IMAGE_HEIGHT                        0x80020017  ///< 图像高度异常（残帧丢弃）
...
#define MV_CODEREADER_E_CONFIG_IP_NOT_RESTART               0x80020208  ///< 配置IP相机立即生效，不重启
#define MV_CODEREADER_E_SUPPORT_MODIFY_DEVICE_IP            0x8002020E  ///< 在固定IP模式下不支持修改设备IP模式
#define MV_CODEREADER_E_KEY_VERIFICATION                    0x8002020F  ///< 秘钥错误
#define MV_CODEREADER_E_REGION_VERIFICATION                 0x80020211  ///< 区域验证失败
#define MV_CODEREADER_E_IP_CONFLICT                         0x80020221  ///< 设备IP冲突
#define MV_CODEREADER_E_GIGE_UNKNOW                         0x800202FF  ///< GIGE未知的错误
